...
public class CustomerOutagesTestConsumer {
    ...
    public void start() {
        this.kafkaListenerEndpointRegistry.getListenerContainer("CustomerOutagesKafkaTestConsumer").start();
    }

    public void stop() {
        this.kafkaListenerEndpointRegistry.getListenerContainer("CustomerOutagesKafkaTestConsumer").stop();
    }
